...
import { COLOR, GRADE, WORKPIECETYPE } from '../../../../../../../../Shared/constants';
    ...
    const subbmitHandler = async () => {
        ...
        const data: iData[] = state.map((item) => {
            const fullModel = fullModels.find(
                (fm) =>
                    fm.WorkpieceType.id == WORKPIECETYPE.ball.id &&
                    fm.SizeRangeModel.id == item.sizeRange.value,
            );
            ...
            return {
                ...
                colorId: COLOR.mix.id,
                workpieceTypeId: WORKPIECETYPE.ball.id,
